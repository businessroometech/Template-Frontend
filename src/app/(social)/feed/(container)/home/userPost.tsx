...
import { Button, ButtonGroup, Card, CardBody, CardFooter, CardHeader, Col, Image } from 'react-bootstrap';
import CommentItem from '@/components/cards/components/CommentItem';
import LoadContentButton from '@/components/LoadContentButton';
import { useAuthContext } from '@/context/useAuthContext';
import useToggle from '@/hooks/useToggle';
import fallBackAvatar from '@/assets/images/avatar/default avatar.png'
import VideoPlayer from '@/components/cards/components/VideoPlayer';
import ResponsiveGallery, { UtilType } from '@/components/cards/components/MediaGallery';
import { FaGlobe } from 'react-icons/fa';
import RepostModal from '@/components/cards/RepostModal';
...
import formatContent from '@/components/cards/components/ContentFormating';
  ...
  useEffect(() => {
    const fetchUserPost = async () => {
        try {
          ...
          setUserInfo(data?.data?.userDetails);
    
          console.log("data?.data?.userDetails", data?.data?.userDetails);
