    ...
    <div className="container-fluid bg-light text-dark min-vh-100">
      <div className="row">
        ...
        <div className="col-md-3 border-end border-secondary p-4">
          ...
          <div className="nav flex-column">
            <Link to="/feed/home" className="nav-link text-dark py-2">🏠 Feed</Link>
            <Link to="/" className="nav-link text-dark py-2">👥 Connections</Link>
            <Link to="/" className="nav-link text-dark py-2">📰 Latest News</Link>
            <Link to="/settings/account" className="nav-link text-dark py-2">⚙️ Settings</Link>
          </div>

          <div className="mt-4">
            <Link to="/profile/about">
              <button className="btn btn-outline-dark w-100">View Profile</button>
            </Link>
          </div>
        </div>
        ...
        <div className="col-md-9 p-4">
          ...
          {/* Sort By Dropdown */}
          <div className="mb-3">
            <label htmlFor="categorySelect" className="form-label text-dark">Sort By Category</label>
            <select 
              id="categorySelect" 
      ...
      {getCurrentData().map((business) => (
        <div key={business.id} className="col-md-6 mb-4">
          <div className="card bg-light border border-secondary h-100">
            <div className="card-header border-bottom border-secondary">
              <h5 className="card-title mb-0">
                {activeTab == "myBusiness" ? business.data.businessName :business.businessName || business.businessType || "Unnamed"}
              </h5>
