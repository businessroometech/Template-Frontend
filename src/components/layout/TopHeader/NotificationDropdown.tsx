...
const NotificationDropdown = () => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await fetch(
        'http://localhost:5000/api/v1/notifications/fetch',
        {
          method: 'POST',
          headers: {
  ...
  const handleOnRead = async (notificationId) => {
    try {
      const response = await fetch(
        'http://localhost:5000/api/v1/notifications/mark-as-read',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleReadAll = async () => {
    try {
      ...
      const response = await fetch(
        'http://localhost:5000/api/v1/notifications/mark-all-as-read',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
